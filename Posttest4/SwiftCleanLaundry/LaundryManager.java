...
public class LaundryManager {
    ...
    public ArrayList<LaundryData> getLaundryList() {
        return laundryList;
    }
    ...
    public void initializeServices() {
        ...
        serviceList.add(new RegularLaundryService("Reguler (Cuci aja / Setrika aja)", 5000));
        serviceList.add(new PremiumLaundryService("CuciSetrika Premium", 10000));
        serviceList.add(new DeluxeLaundryService("CuciSetrika  Deluxe", 8000));
        serviceList.add(new ExpressLaundryService("CuciSetrika Express", 7000));
    }
    ...
    // Overload method untuk menambahkan layanan baru dengan nama layanan dan harga per kg
    public void addService(String serviceName, double pricePerKg) {
        serviceList.add(new LaundryService(serviceName, pricePerKg));
        System.out.println("Layanan baru berhasil ditambahkan: " + serviceName);
    }

    // Overload method untuk menambahkan layanan baru dengan objek LaundryService
    public void addService(LaundryService service) {
        serviceList.add(service);
        System.out.println("Layanan baru berhasil ditambahkan: " + service.getServiceName());
    }
